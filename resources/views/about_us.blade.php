...
@section('content')
    ...
    <div class="page-header header-filter header-small" data-parallax="true"
        style="background-image: url('../assets/img/mang.jpg');">
        <div class="container">
            <div class="row">
            ...
            <div class="about-description text-center">
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto">
                        <h5 class="">We are a time that introduce a diffrent servicse via singel platform and we have a lot of features.</h5>
                        <h5>We are a student fom kng khalid unviersity and information system student.</h5>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-3">
                        <div class="card card-profile card-plain">
                            <div class="card-avatar">
                                <a href="#pablo">
                                    <img class="img" src="../assets/img/saad.jpg">
                                </a>
                            </div>
                            <div class="card-body">
                                <h4 class="card-title">Saad AL-Farea</h4>
                                <h6 class="category text-muted">IS student</h6>
                                <p class="card-description">
                                    I'm student in information system major at king khalid unviersity.
                                </p>
                            </div>
