...
@extends('layout.main')
@section('content')<div class="page-header header-filter header-small" data-parallax="true" style="background-image: url('../assets/img/mang.jpg');">
    <div class="container">
      <div class="row">
        ...
        <div class="row">
          <div class="col-md-6 ml-auto mr-auto text-center">
            <ul class="nav nav-pills nav-pills-rose">
              <li class="nav-item">
                <a class="nav-link " href="#pill1" data-toggle="tab" style="background-color: #1E90FF ; color:white " >Monthly</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#pill2" data-toggle="">Yearly</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
            <div class="card card-pricing card-plain">
              <div class="card-body">
                <h6 class="card-category "style="color: #1E90FF">Free</h6>
          ...
          <div class="col-md-4">
            <div class="card card-pricing card-raised " style="background-color:#F5F5F5 ">
              <div class="card-body">
                <h6 class="card-category " style="color: #1E90FF">Premium</h6>
                ...
                <a  style="color:white"href="#pablo" class="btn btn-white btn-raised btn-round">
                  Get Started
                </a>
              </div>
            </div>
          ...
          <div class="col-md-4">
            <div class="card card-pricing card-plain">
              <div class="card-body">
                <h6 class="card-category "style="color: #1E90FF">Platinum</h6>
